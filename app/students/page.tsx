        ...
        <section className="pt-32 pb-16 px-4">
          <div className="container mx-auto max-w-6xl">
            <div className="flex flex-col items-center gap-8">
              <h1 className="font-serif text-3xl md:text-4xl font-bold text-white text-center drop-shadow-lg">
                Ready to Protect Our Rivers
              </h1>

              <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2">
                  <h2 className="font-serif text-xl md:text-2xl font-semibold mb-6 text-white text-center drop-shadow-md">
                    {question.question}
                  </h2>
                    ...
                    {question.options.map((option, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`p-4 rounded-xl text-left transition-all duration-300 backdrop-blur-md ${
                            showCorrect
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-white font-semibold text-sm drop-shadow">{option}</span>
                          </div>
                        </button>
                      )
                    })}
                    ...
                    {!showExplanation ? (
                      <>
                        <button
                          ...
                          className="px-8 py-3 rounded-full bg-primary text-primary-foreground font-bold text-base hover:bg-primary/90 transition-all shadow-2xl hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          Submit
                        </button>
                        <button
                      ...
                      <>
                        <button
                          onClick={handleSubmitAnswer}
                          disabled
                          className="px-8 py-3 rounded-full bg-primary/50 text-primary-foreground font-bold text-base cursor-not-allowed opacity-50"
                        >
                          Submit
                        </button>
                        <button
                ...
                <div className="lg:col-span-1">
                  {showExplanation && (
                    <div className="h-full p-5 rounded-2xl bg-white/90 backdrop-blur-md border border-white/50 animate-in fade-in slide-in-from-right-4 duration-500 relative overflow-hidden">
